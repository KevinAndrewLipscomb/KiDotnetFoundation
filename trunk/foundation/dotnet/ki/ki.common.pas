...
begin
  ...
  + '		                   <td><small><a href="/WebEMSOF/resource/funding-priorities-epel-fy0607.pdf">Funding Priorities and Eligible Provider Equipment List</a></small></td>'
  + '	                   </tr>'
  + '	                   <tr>'
  + '                      <td valign="top"><li></li></td>'
  + '		                   <td><small><a href="/WebEMSOF/resource/emsi-emsof-allocations-memo-fy0607.pdf">Regional announcement</a></small></td>'
  + '	                   </tr>'
  + '	                   <tr>'
  + '                      <td valign="top"><li></li></td>'
  + '		                   <td><small><a href="/WebEMSOF/resource/terms-and-conditions.pdf">Terms and Conditions</a></small></td>'
  + '	                   </tr>'
  + '                  </table>'
  + '                </td>'
  + '					     </tr>'
